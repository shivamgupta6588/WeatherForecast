...
function TemperatureDetails({weather:{temp, feels_like, details,temp_min,sunrise, sunset,timezone, temp_max,icon, humidity,speed  }}) {
  return (
    <div >
    ...
    <div className=' flex flex-row items-center justify-center space-x-2 text-white text-sm py-3'>
            ...
            <span className='font-medium ml-1m'>{`${temp_max.toFixed()}°`}</span>
